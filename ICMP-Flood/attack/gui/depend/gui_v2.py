...
def stop_attack():
    global stop_event, process_list, status_label
    stop_event.set()
...
def main():
    global ip_entry, duration_entry, size_entry, threads_entry, status_label, stop_button
